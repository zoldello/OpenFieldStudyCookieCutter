...
def connect_to_dj():
    dj.config['database.host'] = {{cookiecutter.database_host}} #Tutorial server
    dj.config['database.user'] = {{cookiecutter.database_user}}
    dj.config['database.password'] = {{cookiecutter.database_host}}
